...
cargo build --release
ffmpeg -i $SCRIPT_DIR/../assets/bus_352x288_30fps_30fr.mp4 -f rawvideo -pix_fmt yuv420p - | cargo run --release --bin rwc -- -i - --input-size 352x288 --num-pictures 30 --qp 20 --output-size 352x288 --reconst $SCRIPT_DIR/../reconstructed.yuv -o $SCRIPT_DIR/../encoded.vvc
